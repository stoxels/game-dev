...
// A giant axe sweeps a fixed pendulum arc; the blade burns on contact.
// Cross the lower arena only while the blade swings far away.
export function _egMechAxePendulum(monster, phase) {
