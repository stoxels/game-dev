...
// below "00:00").
export function _formatTimerDisplay(totalSecs) {
...
export function _getTimerUrgencyClass(secs) {
...
//   ''          - > 600s
export function _getLowTimeVignetteTier(secs) {
...
//   'lhv-active' - ≤ 35% HP
//   ''           - > 35% HP
export function _getLowHealthVignetteTier(pct) {
...
export let _lowTimeWarningShown = { 300: false, 120: false, 30: false };
let _lowTimeLastSecs = null;

export function _getLowTimeWarningTier(secs) {
...
export function _showLowTimeWarningBanner(tier) {
...
export function _maybeShowLowTimeWarning() {
...
export function _applyTimerDisplayState(el) {
...
export function _clearTimerInterval() {
    if (timerInterval) {
...
export function _getPoissonInterval() {
...
export function _initSkillTimers() {
...
export function _initProceduralSystems() {
...
export function _tickPassiveSkills() {
...
export function _calcTimedStasisDuration() {
    let dur = 1000;
...
export function _tickTimedStasis() {
...
export function _getLineFillStats(sol, index, isRow, otherCount) {
    let filled = 0;
    let total = 0;
...
export function _findSparseLine(sol, lineCount, otherCount, isRow) {
...
export function _revealSparseLine(sol, index, otherCount, isRow) {
    const revealedIds = [];
    for (let i = 0; i < otherCount; i++) {
        const r = isRow ? index : i;
        const c = isRow ? i : index;
...
export function _tickLawOfLargeNumbers() {
...
export function _tickCountdown() {
...
export function _tickInventoryUnlock() {
...
export function _tickEmergencyScan() {
...
export function _checkTimerExpired() {
    if (timerSecs > 0) return;
