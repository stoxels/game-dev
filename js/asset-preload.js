...
// Settled urls (loaded, success or failure), urls already in the queue, and
// the queue itself; _active counts in-flight images against MAX_CONCURRENT.
// The _boot* fields drive the blocking boot preload's progress and its
// fail-safe timeout.
const _settled = {};
const _queued = {};
const _pending = [];
...
// Resolves one surface's asset list, following alias entries
// (e.g. 'screen-map-view' -> 'screen-levels').
...
// The public manager consumed by js/boot-loader.js. Kept as one object so
// the boot flow can feature-check individual members (e.g. preloadBoot).
export const AssetPreload = { preloadBoot, startIdle, surfaceShown, installHooks };
