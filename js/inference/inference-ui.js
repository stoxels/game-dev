...
const LEDGER_CATEGORY_ICON = {
    ...
    parameter_space: 'images/Inference/icons/parameter_space.webp',
    probability_gate: 'images/Inference/icons/probability_gate.webp',
    convergence: 'images/Inference/icons/convergence.webp',
    probability_tree: 'images/Inference/icons/probability_tree.webp',
    choose_estimator: 'images/Inference/icons/choose_estimator.webp',
    choose_ascendency: 'images/Inference/icons/choose_ascendency.webp',
    max_likelihood: 'images/Inference/icons/max_likelihood.webp',
    ascendency_mastery: 'images/Inference/icons/ascendency_mastery.webp',
    descriptive_stats: 'images/Inference/icons/descriptive_stats.webp',

    // Gameplay
    confidence_interval: 'images/Inference/icons/confidence_interval.webp',
    guided_scholarship: 'images/Inference/icons/guided_scholarship.webp',
    full_primer_coverage: 'images/Inference/icons/full_primer_coverage.webp',
    elimination_expert: 'images/Inference/icons/elimination_expert.webp',
    exercise_hints: 'images/Inference/icons/exercise_hints.webp',
    lucky_drop_event: 'images/Inference/icons/lucky_drop_event.webp',
    error_correction: 'images/Inference/icons/error_correction.webp',
    curse_ward: 'images/Inference/icons/curse_ward.webp',
    countdown_crisis_master: 'images/Inference/icons/countdown_crisis_master.webp',
    pure_revelation: 'images/Inference/icons/pure_revelation.webp',
    overfitting_gambler: 'images/Inference/icons/overfitting_gambler.webp',
    sample_efficiency_master: 'images/Inference/icons/sample_efficiency_master.webp',
    future_glimpse: 'images/Inference/icons/future_glimpse.webp',
    signal_noise_master: 'images/Inference/icons/signal_noise_master.webp',
    oracle_vision: 'images/Inference/icons/oracle_vision.webp',
    degrees_of_freedom_master: 'images/Inference/icons/degrees_of_freedom_master.webp',
    random_walk_survivor: 'images/Inference/icons/random_walk_survivor.webp',
    emergency_response: 'images/Inference/icons/emergency_response.webp',
    gamblers_fortune: 'images/Inference/icons/gamblers_fortune.webp',
    entropy_drain_master: 'images/Inference/icons/entropy_drain_master.webp',
    dead_reckoning_navigator: 'images/Inference/icons/dead_reckoning_navigator.webp',
    frequentists_burden_master: 'images/Inference/icons/frequentists_burden_master.webp',
    field_scan_revelation: 'images/Inference/icons/field_scan_revelation.webp',
    sparse_prior_master: 'images/Inference/icons/sparse_prior_master.webp',
    confidence_interval_master: 'images/Inference/icons/confidence_interval_master.webp',
    adjacency_matrix_master: 'images/Inference/icons/adjacency_matrix_master.webp',
    minesweeper_mind: 'images/Inference/icons/minesweeper_mind.webp',

    // Items & Classes
    null_hypothesis: 'images/Inference/icons/null_hypothesis.webp',
    item_distribution: 'images/Inference/icons/item_distribution.webp',
    curse_dimensionality: 'images/Inference/icons/curse_dimensionality.webp',
    prior_distribution: 'images/Inference/icons/prior_distribution.webp',
    witch_immunity: 'images/Inference/icons/witch_immunity.webp',
    erasure_engine: 'images/Inference/icons/erasure_engine.webp',
    cartographic_mastery: 'images/Inference/icons/cartographic_mastery.webp',
    tutor_regression: 'images/Inference/icons/tutor_regression.webp',
    active_inference: 'images/Inference/icons/active_inference.webp',
    ability_marathon: 'images/Inference/icons/ability_marathon.webp',
    ability_harvest: 'images/Inference/icons/ability_harvest.webp',
    shadow_seal_init: 'images/Inference/icons/shadow_seal_init.webp',

    // Challenges
    significance_level: 'images/Inference/icons/significance_level.webp',
    time_pressure: 'images/Inference/icons/time_pressure.webp',
    outlier_resistance: 'images/Inference/icons/outlier_resistance.webp',
    ironman_dist: 'images/Inference/icons/ironman_dist.webp',
    prior_free_estimation: 'images/Inference/icons/prior_free_estimation.webp',
    tabula_rasa: 'images/Inference/icons/tabula_rasa.webp',
    monte_carlo: 'images/Inference/icons/monte_carlo.webp',
    zero_variance: 'images/Inference/icons/zero_variance.webp',
    precision_large: 'images/Inference/icons/precision_large.webp',

    // Atlas Tiers 1-16
    atlas_tier_1: 'images/Inference/icons/parameter_space.webp',
    atlas_tier_2: 'images/Inference/icons/parameter_space.webp',
    atlas_tier_3: 'images/Inference/icons/parameter_space.webp',
    atlas_tier_4: 'images/Inference/icons/parameter_space.webp',
    atlas_tier_5: 'images/Inference/icons/parameter_space.webp',
    atlas_tier_6: 'images/Inference/icons/parameter_space.webp',
    atlas_tier_7: 'images/Inference/icons/parameter_space.webp',
    atlas_tier_8: 'images/Inference/icons/parameter_space.webp',
    atlas_tier_9: 'images/Inference/icons/parameter_space.webp',
    atlas_tier_10: 'images/Inference/icons/parameter_space.webp',
    atlas_tier_11: 'images/Inference/icons/parameter_space.webp',
    atlas_tier_12: 'images/Inference/icons/parameter_space.webp',
    atlas_tier_13: 'images/Inference/icons/convergence.webp',
    atlas_tier_14: 'images/Inference/icons/convergence.webp',
    atlas_tier_15: 'images/Inference/icons/convergence.webp',
    atlas_tier_16: 'images/Inference/icons/convergence.webp',
};
 ...
 * Currently unused: the claim flow shows the banner in inference-logic.js
 * @param {Object} milestone
 * @param {Object} category
 */
